...
impl RequestValidator {
    ...
    pub fn validate_memory_item(&self, memory: &MemoryItem) -> Result<(), ValidationError> {
        ...
        memory.validate().map_err(|e| ValidationError::InvalidInput {
            message: format!("Memory validation failed: {:?}", e),
        })?;
        
        // Custom validation
        memory.validate_custom().map_err(|e| ValidationError::InvalidInput {
    ...
    pub fn validate_query_filter(&self, filter: &QueryFilter) -> Result<(), ValidationError> {
        filter.validate().map_err(|e| ValidationError::InvalidInput {
    ...
    pub async fn validate_user_quota(&self, db: &Database, user_id: &str) -> Result<(), ValidationError> {
        ...
        let response = db.recall_memories(&filter).map_err(|e| ValidationError::InvalidInput {
