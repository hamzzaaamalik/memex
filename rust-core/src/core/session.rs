...
impl SessionManager {
    ...
    pub fn update_session(
        ...
        log::debug!(
            "Updated session {} with name: {:?}, tags: {:?}",
            session_id,
            name,
            tags
        );
...
mod tests {
    ...
    fn test_create_and_get_sessions() {
        ...
        let session1 = manager
            .create_session("test_user", Some("Session 1".to_string()))
            .unwrap();
        let session2 = manager
            .create_session("test_user", Some("Session 2".to_string()))
            .unwrap();
    ...
    fn test_key_topic_extraction() {
        ...
        assert!(
            topics.contains(&"market".to_string())
    ...
    fn test_session_analytics() {
        ...
        manager
            .create_session("test_user", Some("Active Session".to_string()))
            .unwrap();
        manager
            .create_session("test_user", Some("Quiet Session".to_string()))
            .unwrap();
